...
String _cosmeticDescription(AppLocalizations l10n, String id) => switch (id) {
  ...
  'color_echo_orbit' => l10n.cosmeticEchoOrbitDescription,
  ...
  'trail_checksum_scar' => l10n.cosmeticChecksumScarDescription,
